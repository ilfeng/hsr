...
define(['jquery', 'core', 'ui-panel', 'ui-tool-manager'], function ($, hsr, _super, ToolUtils) {
     ...
     * @constructor
     */
    function FontPickerClass(element, options) {
        // 私有属性。
        var self = this;
    ...
    // 继承父类。
    hsr.inherit(FontPickerClass, _super);
    ...
    var metedata = {
         ...
         * @readonly
         */
        cssClass: '@CSS_PREFIX@picker-font',
        /**
         * 名称。
         * @type {string}
         * @readonly
    ...
    $.extend(FontPickerClass, metedata);

    // 注册组件。
    ToolUtils.regiest(FontPickerClass);

    /***********公共(及特权)方法***********/
    $.extend(FontPickerClass.prototype, metedata, {
        /**
         * 创建配置属性。
         * 
