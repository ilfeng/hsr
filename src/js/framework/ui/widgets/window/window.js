...
define(['jquery', 'core', 'ui-panel', 'ui-tool-manager'], function ($, hsr, _super, ToolUtils) {
     ...
     * @constructor
     */
    function WindowClass(element, options) {
        // 私有属性。
        var self = this;
    ...
    // 继承父类。
    hsr.inherit(WindowClass, _super);
    ...
    $.extend(WindowClass, metedata);
    
    // 注册组件。
    ToolUtils.regiest(WindowClass);

    /***********公共(及特权)方法***********/
    $.extend(WindowClass.prototype, metedata, {
        /**
         * 创建控件。
         * 
