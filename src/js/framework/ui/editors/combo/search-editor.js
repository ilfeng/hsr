...
define(['jquery', 'core', 'ui-editor', 'ui-tool-manager'], function ($, hsr, _super, ToolUtils) {
     ...
     * @constructor
     */
    function SearchEditorClass(element, options) {
        // 私有属性。
        var self = this;
    ...
    // 继承父类。 
    hsr.inherit(SearchEditorClass, _super);
    ...
    var metedata = {
         ...
         * @readonly
         */
        cssClass: '@CSS_PREFIX@editor-search',
        /**
         * 名称。
         * @type {string}
         * @readonly
         */
        typeName: 'SearchEditor'
    };

    $.extend(SearchEditorClass, metedata);

    // 注册组件。
    ToolUtils.regiest(SearchEditorClass);

    /***********公共(及特权)方法***********/
    $.extend(SearchEditorClass.prototype, metedata, {
        /**
         * 创建配置属性。
         * 
